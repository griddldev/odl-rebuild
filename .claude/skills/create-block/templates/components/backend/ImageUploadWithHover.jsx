...
export const ImageUploadWithHover = ({
  ...
  return (
    <MediaUpload
      ...
      render={({ open }) => (
        <div
          className="relative flex h-full w-full cursor-pointer justify-center rounded text-center"
          onClick={open}
          ...
          onMouseEnter={(e) => {
            ...
            const removeBtn =
              e.currentTarget.querySelector('.remove-image-btn');
        ...
        >
          {imageUrl ? (
            ...
            <div
              className={`flex h-full w-full items-center justify-center ${widthContainer} ${placeholderBg} ${placeholderBgColor}`}
              style={{ height }}
            >
